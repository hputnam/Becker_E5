...
## Read in genetic relatedness .gz file made from original sample .bam files, called for SNP variants, filtered, and made from PLINK software for genetic relatedness metrics
```{r}
# Read the GRM file
