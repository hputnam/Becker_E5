...
length.struct.annot <- read.gff("../../Genome/Pver_genome_assembly_v1.0.gene.gff3", col_names = TRUE)
length.struct.annot$length <- length.struct.annot$ - length.struct.annot$
...
#OBTAIN THE LENGTH FROM THE GFF3 FILE
