...
test.GFF.GO <- full_join(GFF3, Annot, by = "gene_id")
nrow(test.GFF.GO)
#conclusion: we have 672 more genes than the expected 27,439 after we merge these two files, a number of gene ID names are present in the GO annotation file in annot that do not exist the gene names of the GFF3
...
#GFF3 has #Pver_gene_novel_gene_281_5de57afd# and Annot has Pver_novel_model_817_5de57afd
