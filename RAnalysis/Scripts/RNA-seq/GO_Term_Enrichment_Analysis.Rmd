...
GFF3$gene_id <-  gsub("_gene_g","_g",GFF3$gene_id)
GFF3$gene_id <-  gsub("_gene_","_",GFF3$gene_id)
GFF3$gene_id <-  gsub("_split_","_",GFF3$gene_id)


Annot$gene_id <-  gsub("_gene_g","_g",Annot$gene_id)
Annot$gene_id <-  gsub("_gene_","_",Annot$gene_id)
...
gcount <- read.csv("RAnalysis/Data/RNA-seq/Poc_gene_count_matrix.csv")
...
#test after GFF3 and Annot changes
test.GFF.GO.DEG <- full_join(GFF3, gcount, by = "gene_id")
nrow(test.GFF.GO.DEG)
