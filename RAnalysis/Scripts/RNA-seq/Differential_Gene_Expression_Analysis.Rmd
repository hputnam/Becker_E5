...
#in for loop, receiving "Error: Invalid grouping factor specification, treatment:block" which others have run into and said it is due to NA values which are not present throughout our data frames
...
#when run with DESeq2, 223 signifcant DEGs, when run with glmer 1,953
