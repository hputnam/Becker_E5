...
pdf(file = "../../Output/Final_Figures/DEGSeq2_heatmap.pdf")
DEGSeq2_heatmap
dev.off()
...
ggsave(path = "../../Output/Final_Figures/", filename = "DEGSeq2_PCA_plot.pdf")

# PCA plot is of deferentially expressed genes only

# Save results

write.csv(counts(DEGSeq2_list), file="../../Output/RNA-seq/DEG/DEGSeq2_list_unique.csv")
