...
```{r, message = FALSE}
DEGSeq2.results <- results(DEG_wald, contrast=c("treatment","control","enriched")) #see code underlying function is to apply to glmer DEG results, FDR correction
...
write.csv(counts(DEGs_list), file="../../Output/RNA-seq/DEG/DEGSeq2_list_unique.csv")
