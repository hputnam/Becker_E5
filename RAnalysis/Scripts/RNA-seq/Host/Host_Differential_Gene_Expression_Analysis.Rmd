...
#gene count matrix
gcount <- as.data.frame(read.csv("RAnalysis/Data/RNA-seq/P.verrucosa/Host/Poc_gene_count_matrix.csv"))
...
test$treatment <-treatmentinfo$treatment[match(test$sample_ID, treatmentinfo$sample_ID)]
```
