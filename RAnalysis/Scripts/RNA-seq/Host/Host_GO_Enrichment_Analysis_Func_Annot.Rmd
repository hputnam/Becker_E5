...
#all genes
DEG <- gcount_filt[gcount_filt$gene_id %in% DEG.res$gene_id, ][-1]
dim(DEG) # 252 x 10
DEG_names <- as.vector(DEG$gene_id)
gene_vector <- as.integer(gcount_filt$gene_id%in%DEG_names)
names(gene_vector) <-gcount_filt$gene_id
