...
MF_plot_GO <- GO.MF  %>%  mutate(term = fct_reorder(term, -log10(over_represented_pvalue))) %>%
 ...
 ggsave("RAnalysis/Output/RNA-seq/GOSeq/GO.plot.MF.terms.pdf", MF_plot_GO , width = 40
        , height = 40, units = c("in"))
 ...
 ggsave("RAnalysis/Output/RNA-seq/GOSeq/GO.plot.BP.terms.pdf", BP_plot_GO , width = 10, height = 30, units = c("in"))
 ...
 ggsave("RAnalysis/Output/RNA-seq/GOSeq/GO.plot.CC.terms.pdf", CC_plot_GO , width = 15, height = 10, units = c("in"))
```
