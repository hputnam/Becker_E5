...
#input data
```{r}
f_gene_groups=c('RAnalysis/Data/WGBS/dendogram/dendogram_DMG_parent_terms.csv') 
```
...
gene_groups_direction='percentDEInCat' #calculated as (number of DMGs in each GO/total number of genes in GO term)*100 _this is the percentage of differentially expressed 
