...
gg1 <- ggtree(hc, layout = 'rectangular') %<+% cutr_tightClusters +
  geom_tippoint(aes(color = as.factor(cluster)), shape = "triangle", size = 8) +
  scale_colour_manual(values = colors1) +
  geom_tiplab(aes(label = label_upper), offset = 0.1, size = 6) +
  xlim(-3, 3)
  ...
  gg2 = gg2 + viridis::scale_fill_viridis(na.value=NA, option = "magma")
...
term_order <- c("Biological regulation", "Biological process involved in interspecies interaction", "Cell cycle process", "Cellular amino acid metabolic process", "Microtubule-based movement", "Muscle system process", "Peroxisome organization", "Protein modification process", "Reproduction", "Telomere organization", "Vitamin metabolic process", "Immune system process", "Carboxylic acid metabolic process", "Protein localization", "Cytoskeleton organization", "Nitrogen compound metabolic process", "Sulfur compound metabolic process", "Detoxification", "Protein maturation",  "mRNA metabolic process", "DNA repair", "DNA-templated transcription", "Lipid metabolic process", "Glutamine transport", "Cytolysis", "Cellular process", "Protein folding", "Intracellular protein transport", "Cell motility", "Catalytic activity", "Positive regulation of phospholipase activity", "Transport", "Transmembrane transport", "Protein-containing complex assembly", "Nervous system process", "DNA replication", "Anatomical structure development", "Protein catabolic process", "Vesicle-mediated transport", "Regulation of lipid storage", "Multicellular organismal process", "Cell differentiation", "Regulation of transport", "Regulation of macromolecule metabolic process", "Regulation of reactive oxygen", "Cellular component organization or biogenesis", "Regulation of cellular process", "Regulation of biological process", "Carbohydrate metabolic process", "Signaling", "Response to nitrogen compound", "Response to stimulus", "Response to nutrient levels", "Response to stress", "Modulation by symbiont of host process", "Reproductive process", "Programmed cell death", "Carbohydrate derivative metabolic process")
...
gg3 = ggplot(clusters, aes(x = comparison, y = term_name, size = set_size)) + 
  ...
  scale_size(limits = c(1, 789)) +
  labs(color = "%DEGs", size = "Number of Genes") +
  theme(panel.background = element_blank())

print(gg3)

ggsave("RAnalysis/Output/Dendograms/clusters_dotplot_DEG_BP.png",
       dpi = 300, 
       width = 10,
       height = 10)
