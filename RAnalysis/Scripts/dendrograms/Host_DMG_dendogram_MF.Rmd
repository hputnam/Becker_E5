...
colors1 <- c('lightskyblue', 'dodgerblue', 'steelblue', 'royalblue', 'navyblue', 'forestgreen', 'limegreen', 'seagreen', 'olivedrab', 'darkolivegreen', 'indianred', 'darkseagreen', 'mediumpurple', 'slategray', 'darkslateblue', 'darkred', 'red', 'maroon', 'darkslategrey', 
             'purple', rainbow(n=100))   #colors for the dendrogram clusters
...
gg1 = ggtree(hc, layout = 'rectangular') %<+% cutr_tightClusters + #edits layout of tree
  ...
  gg2 = gheatmap(gg1, scores2, offset=2.1, width=0.1, font.size= 5) 
