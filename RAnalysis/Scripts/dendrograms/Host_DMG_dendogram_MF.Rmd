...
PCA.DMG <- rasterGrob(DEG.PCA, interpolate=TRUE)
...
bottom_row.DMG <- plot_grid(dendo.BP2, dendo.MF2, label_size = 60)
Figure1 <- plot_grid(PCA.DMG, bottom_row.DMG, labels = c('A', ''), label_size = 60, ncol = 1) 

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/dendogram_DMG.png"), plot=Figure1, dpi=300,width=50, height=50, units="in", limitsize = FALSE)
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/dendogram_DMG.pdf"), plot=Figure1, dpi=300, width=50, height=50, units="in", limitsize = FALSE)
