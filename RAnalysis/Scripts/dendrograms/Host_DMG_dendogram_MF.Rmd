...
gg3 = ggplot (clusters, aes(x = comparison, y = term_name, size = set_size)) + 
            ...
            scale_size(limits = c(5, 1452)) +  # Set the limits here
            labs(color = "%DEGs", size = "Set Size") +
            theme(panel.background = element_blank())

print(gg3)

ggsave("RAnalysis/Output/Dendograms/clusters_dotplot_MF.png",
       dpi = 300, 
       width = 5,
       height = 5)
...
bottom_row.DEG <- plot_grid(dendo.BP2, dendo.MF2, label_size = 60)
Figure1 <- plot_grid(PCA.DEG, bottom_row.DEG, labels = c('A', ''), label_size = 60, ncol = 1) 

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/dendogram_DEG.png"), plot=Figure1, dpi=300,width=50, height=50, units="in", limitsize = FALSE)
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/dendogram_DEG.pdf"), plot=Figure1, dpi=300, width=50, height=50, units="in", limitsize = FALSE)
