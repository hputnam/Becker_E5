...
Create methytlaion all genes summary for mean meth percent per treatment for downstream analysis
```{r}
gene_dnam <- MD.10x # rename for downstream 
...
#saveRDS(meth_summary,"RAnalysis/Data/meth_summary.RData")
```
