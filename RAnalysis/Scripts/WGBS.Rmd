...
# Remove samples that had low data coverage from following analysis 
MD.10x_filtered <- MD.10x[!(MD.10x$fragment.ID %in% c('PV_28', 'PV_7', 'PV_8')), ]
...
sub_meth_table.10x  <- MD.10x_filtered 
