...
```{r}
# Extract the methylation data from DMGvst_subset
# Extract the transformed count data
dmg_counts <- assay(DMGvst)

# Create a distance matrix
dist_matrix <- vegdist(t(dmg_counts), method = "bray")

# Prepare the metadata
metadata <- as.data.frame(colData(DMGvst))
...
disp <- betadisper(dist_matrix, group = metadata$treatment)
