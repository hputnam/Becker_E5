...
genes_of_interest <- read.csv("RAnalysis/Output/gene_list_separated.csv")[-1]

# Filter DEG.res to only include genes of interest
DMG.res_filtered <- DMG.res[DMG.res$gene_id %in% genes_of_interest$gene_id, ]
...
# Combine top results for hypo and hyporeagulated BP
Enrichment_Res_BP_10 <- rbind(allRes_hypo_BP_10)
...
# Combine top results for hypo and hyporeagulated MF
Enrichment_Res_MF_10 <- rbind(allRes_hypo_MF_10)
