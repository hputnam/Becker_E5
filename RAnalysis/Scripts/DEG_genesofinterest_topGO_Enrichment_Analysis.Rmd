...
genes_of_interest <- read.csv("RAnalysis/Output/gene_list_separated.csv")

# Filter DEG.res to only include genes of interest
DEG.res_filtered <- DEG.res[DEG.res$gene_id %in% genes_of_interest$gene_id, ]
