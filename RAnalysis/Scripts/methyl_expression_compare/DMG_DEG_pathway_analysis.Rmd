...
write.csv(DMG, file = "RAnalysis/Output/WGBS/GO.terms.parent.terms.csv")
...
for (category in ontologies) {
    ...
    go_results<-read_csv(file = paste0("RAnalysis/Output/WGBS/GO.terms.parent.terms.csv"))
...
ggsave(filename=paste0("RAnalysis/Output/meth_express_compare/DMG_plot", "_", category, ".png"), plot=GO.plot, dpi=100, width=12, height=22, units="in", limitsize=FALSE)
