...
ggsave("RAnalysis/Output/Final_Figures/Host/DMG.complete.slimterms.pdf", GO.plot.DMG.complete, width = 20, height = 49.5, units = c("in"))
ggsave("RAnalysis/Output/Final_Figures/Host/DMG.complete.slimterms.png", GO.plot.DMG.complete, width = 20, height = 49.5, units = c("in"))
...
vector1 <- c("nitrogen", "oxygen", "glucose", "carbon", "heat", "nutrient", "carbohydrate", "oxidative", "glutamate", "glutathione", "protein metabolic process", "amino acid", "oxidoreductase activity", "DNA replication", "DNA repair", "immune", "protein folding", "stress", "protein modification process", "protein transport")
...
heat <- c("heat", "DNA replication", "DNA repair", "immune", "protein folding", "stress")
...
heat.dat <- rbind(heat.DEG,heat.DMG)
  ...
  heat.GO.plot <-  ggplot(heat.dat, aes(x = type, y = term)) + 
    geom_point(aes(size=numInCat, fill=bh_adjust, colour=bh_adjust)) + 
    scale_size(name="Number of Genes", range=c(5,12), limits=c(1,150))+
    scale_fill_gradient(name = "Adjusted p-value", low="black", high="gray")+
    scale_colour_gradient(name = "Adjusted p-value", low="black", high="gray")+
    facet_grid(slim_term ~ ., scales = "free", space='free', labeller = label_wrap_gen(width = 8, multi_line = TRUE))+
    xlab("Analysis")+
...
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/specific_pathways/heat.DMG.DEG.png"), plot=heat.GO.plot, dpi=300, width=20, height=15, units="in")
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/specific_pathways/heat.DMG.DEG.pdf"), plot=heat.GO.plot, dpi=300, width=20, height=15, units="in")
...
amino.dat <- rbind(amino.DEG,amino.DMG)
  ...
  amino.GO.plot <-  ggplot(amino.dat, aes(x = type, y = term)) + 
    geom_point(aes(size=numInCat, fill=bh_adjust, colour=bh_adjust)) + 
    scale_size(name="Number of Genes", range=c(5,12), limits=c(1,10))+
    scale_fill_gradient(name = "Adjusted p-value", low="black", high="gray")+
    scale_colour_gradient(name = "Adjusted p-value", low="black", high="gray")+
    facet_grid(slim_term ~ ., scales = "free", space='free', labeller = label_wrap_gen(width = 8, multi_line = TRUE))+
    xlab("Analysis")+
...
```{r}
Figure2 <- nutrient.GO.plot + nitrogen.GO.plot + carb.GO.plot + plot_annotation(tag_levels = 'A')
Figure3 <- glucose.GO.plot + glutamate.GO.plot + oxy.GO.plot + plot_annotation(tag_levels = 'A')
Figure4 <- heat.GO.plot + amino.GO.plot + protein.GO.plot + cell.GO.plot + plot_annotation(tag_levels = 'A')
 
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/nitrogen.carb_pathways.png"), plot=Figure2, dpi=300, width=40, height=15, units="in")
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/nitrogen.carb_pathways.pdf"), plot=Figure2, dpi=300, width=40, height=15, units="in")

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/glut.oxy.pathways.png"), plot=Figure3, dpi=300, width=40, height=15, units="in")
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/glut.oxy.pathways.pdf"), plot=Figure3, dpi=300, width=40, height=15, units="in")

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/heat.protein.pathways.png"), plot=Figure4, dpi=300, width=45, height=45, units="in")
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/heat.protein.pathways.pdf"), plot=Figure4, dpi=300, width=45, height=45, units="in")
```
