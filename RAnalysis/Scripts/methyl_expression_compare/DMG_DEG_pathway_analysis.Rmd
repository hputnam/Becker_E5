...
unique.DEG <- unique(DEG.complete$slim_term)
unique.DEG <- data_frame(unique.DEG)
unique.DEG <- unique.DEG %>% 
       rename("slim_term" = "test1")

unique.DMG <- unique(DMG.complete$slim_term)
unique.DMG <- data_frame(unique.DMG)
#remove NAs 
unique.DMG <- unique.DMG[!is.na(unique.DMG$test2), ]
