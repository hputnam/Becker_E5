...
bottom_row.DEG <- plot_grid(GO.plot.DEG.BP, GO.plot.DEG.MF, labels = c('B', 'C'), label_size = 60)
...
bottom_row.DMG <- plot_grid(GO.plot.DMG.BP, GO.plot.DMG.MF, labels = c('B', 'C'), label_size = 60)
...
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/glut.oxy.pathways.png"), plot=Figure4, dpi=300, width=40, height=15, units="in")
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/glut.oxy.pathways.pdf"), plot=Figure4, dpi=300, width=40, height=15, units="in")
