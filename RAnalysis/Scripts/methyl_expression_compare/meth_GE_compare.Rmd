...
list_E <- filter(meta.data, treatment == "enriched") 

list_C <- filter(meta.data, treatment == "control") 
  
# mean gene meth enriched per E sample ID
mean_E <- rowMeans(m[, list_E$Sample_ID == "[E]+"])

# Mean gene meth control
mean_C <- rowMeans(m[, list_C$treatment == "control"])
