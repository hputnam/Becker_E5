...
saveRDS(dge_gene, "../../Data/GE_meth_compare/RNA_gene_preNormalization_DGEListObj.Rdata")
```
...
gene_dnam <- readRDS("../../Output/WGBS/sample_all_methylated_data_10x.Rdata") #read in info
