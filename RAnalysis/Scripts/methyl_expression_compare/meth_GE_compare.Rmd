...
ggsave(meth_meanexpress, filename="RAnalysis/Output/Final_Figures/ME_meth_correlation.png", height = 7, width = 15)
...
ggsave(fig_GE_meth, filename="RAnalysis/Output/Final_Figures/GbM_GE_correlation.png", height = 7, width = 9)
