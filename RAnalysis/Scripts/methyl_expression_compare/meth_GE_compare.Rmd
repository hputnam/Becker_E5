...
control <- ggplot(df,aes(x=per_meth_C,y=log_gene_C)) + 
  ...
  stat_cor(method = "pearson", label.x = 65, label.y = 0.5) +
...
ggsave(meth_meanexpress, filename="RAnalysis/Output/Final_Figures/Host/ME_meth_correlation.png", height = 7, width = 15)
...
ggsave(fig_GE_meth, filename="RAnalysis/Output/Final_Figures/Host/GbM_GE_correlation.png", height = 7, width = 15)
