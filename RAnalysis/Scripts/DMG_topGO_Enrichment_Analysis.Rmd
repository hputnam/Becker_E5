...
# Count the number of unique gene_id values
num_unique_genes <- length(unique(annot_GO$gene_id))

# Display the count
print(num_unique_genes) #24,037
...
```
364 genes in mmethylation data do not have GO annotations
...
numSigGenes(GOdata.hyper_BP) #157
...
#printGraph(GOdata.hyper_BP, fisher.hyper_BP, firstSigNodes = 5, fn.prefix = "RAnalysis/Output/tGO_graph_Hypermethylated_BP", useInfo = "def", pdfSW = TRUE)
...
# measures number sig genes
numSigGenes(GOdata.hypo_BP) #120
...
# Print graph with specific parameters and save to directory
#printGraph(GOdata.hypo_BP, fisher.hypo_BP, firstSigNodes = 5, fn.prefix = "RAnalysis/Output/tGO_graph_Hypomethylated_BP", useInfo = "def", pdfSW = TRUE)
...
# measures number sig genes
numSigGenes(GOdata.hyper_MF) #178
...
# Print graph with specific parameters and save to directory
#printGraph(GOdata.hyper_MF, fisher.hyper_MF, firstSigNodes = 5, fn.prefix = "RAnalysis/Output/tGO_graph_Hypermethylated_MF", useInfo = "def", pdfSW = TRUE)
...
# measures number sig genes
numSigGenes(GOdata.hypo_MF) #141
...
# Print graph with specific parameters and save to directory
#printGraph(GOdata.hypo_MF, fisher.hypo_MF, firstSigNodes = 5, fn.prefix = "RAnalysis/Output/tGO_graph_Hypomethylated_MF", useInfo = "def", pdfSW = TRUE)
...
# measures number sig genes
numSigGenes(GOdata.hyper_CC) #93
