...
plot.DMG <- ggplot(means.DMG, aes(x=treatment, y=per.meth)) +
  geom_bar(stat="identity", color="black",
             position=position_dodge()) +
    geom_errorbar(aes(ymin=per.meth-ses, ymax=per.meth+ses), width=.2,
                  position=position_dodge(.9)) +
...
plot.global <- ggplot(means.global, aes(x=treatment, y=per.meth)) +
  geom_bar(stat="identity", color="black",
             position=position_dodge()) +
    geom_errorbar(aes(ymin=per.meth-ses, ymax=per.meth+ses), width=.2,
                  position=position_dodge(.9)) +
    xlab("Treatment") + #plot x axis label
    ylab("Global Percent Methylation") + #plot y axis label
    #ylim(0,100)+ #set y limits to 0 and 100%
    theme_bw()
...
plot.dmg.deg <- ggplot(means.dmg.deg, aes(x=treatment, y=per.meth)) +
  geom_bar(stat="identity", color="black",
             position=position_dodge()) +
    geom_errorbar(aes(ymin=per.meth-ses, ymax=per.meth+ses), width=.2,
                  position=position_dodge(.9)) +
