...
nrow(GO.sig.trt)
nrow(filter(GO.sig.trt, ontology=="BP")) #number sig BP terms (74)
nrow(filter(GO.sig.trt, ontology=="MF")) #number sig MF terms (38)
nrow(filter(GO.sig.trt, ontology=="CC")) #number sig CC terms (5)
