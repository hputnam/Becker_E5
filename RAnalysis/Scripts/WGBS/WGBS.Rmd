...
#load genes gff 
Genes <- read.csv("RAnalysis/Output/RNA-seq/DEG/rename_structure_gff3.csv") #read in data fill
...
ggsave(path = "RAnalysis/Output/Final_Figures/", filename = "meth_general_PCA_plot_host.pdf")
ggsave(path = "RAnalysis/Output/Final_Figures/", filename = "meth_general_PCA_plot_host.png")
...
DMG.PCA <- readPNG("RAnalysis/Output/Final_Figures/DMG_PCA_plot_host.png")

PCA.DMG <- rasterGrob(DMG.PCA, interpolate=TRUE)

Figure2 <- plot_grid( DMG.volcano, PCA.DMG, labels = c('A', 'B'), label_size = 14)

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/manuscript/DMG.PCA.volcano.png"), plot=Figure2, dpi=300, width=12, height=5, units="in", limitsize = FALSE)

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/manuscript/DMG.PCA.volcano.pdf"), plot=Figure2, dpi=300, width=12, height=5, units="in", limitsize = FALSE)

# write final df with log2fold change info
write.csv(final_df, "RAnalysis/Output/WGBS/DMGs_all.csv")
```
...
ggsave("RAnalysis/Output/Final_Figures/DMG_PCA_plot_host.png", DMG_PCA_plot, width = 5, height = 5, units = c("in"))
ggsave("RAnalysis/Output/Final_Figures/DMG_PCA_plot_host.pdf", DMG_PCA_plot, width = 10, height = 10, units = c("in"))
