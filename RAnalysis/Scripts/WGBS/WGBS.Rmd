...
subdf.DMG <- MD.10x  %>%	
  filter(gene == DMG.sig.annot.10x$gene[i])
...
#results: Kruskal-Wallis chi-squared = 3.9272, df = 1, p-value < 0.04751, significantly higher percent meth in DMGs in enriched treatment
