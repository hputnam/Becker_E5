...
DMG.volcano <- ggplot(final_df, aes(x = log2FoldChange, y = -log10(padj), color = methylation_status)) +
  ...
  scale_color_manual(values = colors, name = "Methylation Status (padj < 0.05)", 
...
Figure2 <- plot_grid(PCA.DMG, DMG.volcano, labels = c('A', 'B'), label_size = 14)

ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/DMG.PCA.volcano.png"), plot=Figure2, dpi=300, width=10, height=5, units="in", limitsize = FALSE)
ggsave(filename=paste0("RAnalysis/Output/Final_Figures/Host/manuscript/DMG.PCA.volcano.pdf"), plot=Figure2, dpi=300, width=10, height=5, units="in", limitsize = FALSE)

```



# Conduct PERMANOVA and PCA on global expression 
...
ggsave(path = "RAnalysis/Output/Final_Figures/Host/", filename = "DMG_PCA_plot_host.pdf")
ggsave(path = "RAnalysis/Output/Final_Figures/Host/", filename = "DMG_PCA_plot_host.png")
