...
vector1 <- c("nitrogen", "stress", "glutamate", "glutamine", "protein", "carbon", "glucose", "nucleic acid",  "carbohydrate", "lipid", "amino acid", "DNA repair", "DNA metabolic process", "DNA binding", "transport", "immune response", "signaling", "DNA metabolic process", "oxioreductase", "glutathione", "DNA integration", "protein binding", "catalytic activity", "RNA-binding", "transcription")

phenotype.pathways.DEG <- DEG_with_genes%>%
      filter(grepl(paste(vector1, collapse="|"), paste(Term))) 
