...
length(common_gene_ids) #unique gene_ids = 3,210
...
count_non_missing <- combined_data %>%
  ...
  tally() #574 genes with meth and express data
...
# write dataframe
write.csv(final_df, "RAnalysis/Output/gene_list_meth_express_cleaned.csv")
