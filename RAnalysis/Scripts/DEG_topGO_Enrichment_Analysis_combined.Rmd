...
# Set the file path and name
pdf("RAnalysis/Output/tGO_graph_downregulated_BP.pdf")
# Generate the graph using printGraph
showSigOfNodes(GOdata.down_BP, score(fisher.down_BP), firstSigNodes = 5, useInfo = 'all')
# Close the PDF device
dev.off()
...
# Set the file path and name
pdf("RAnalysis/Output/tGO_graph_upregulated_MF.pdf")
# Generate the graph using printGraph
showSigOfNodes(GOdata.up_MF, score(fisher.up_MF), firstSigNodes = 5, useInfo = 'all')
# Close the PDF device
dev.off()
...
pdf("RAnalysis/Output/tGO_graph_downregulated_MF.pdf")
# Call printGraph
printGraph(GOdata.down_MF, fisher.down_MF, firstSigNodes = 5, fn.prefix = "tGO", useInfo = "def", pdfSW =TRUE)
# Close the PDF device
dev.off()
