...
length(na.omit(pver_annot$TREMBL_.Hits)) # 6,743 sequences had hits against SwissProt database
...
length(na.omit(pver_annot$BLAST_.Hits)) # 26,426 sequences had hits against SwissProt database
...
length(unique(GO_all$gene_id)) # 24,037 gene_ids have one or more GO terms, means that not all gene models got assigned GO terms (3,402 did not)
